...
enum PermissionLevel: int
{
    ...
    {
        return match ($this) {
            self::OBSERVER => 'bg-slate-100 dark:bg-slate-800',
            self::CONTRIBUTOR => 'bg-blue-100 dark:bg-blue-900',
            self::MANAGER => 'bg-emerald-100 dark:bg-emerald-900',
            self::ADMIN => 'bg-indigo-100 dark:bg-indigo-900',
        };
    }
    ...
    {
        return match ($this) {
            self::OBSERVER => 'text-slate-600 dark:text-slate-300',
            self::CONTRIBUTOR => 'text-blue-600 dark:text-blue-300',
            self::MANAGER => 'text-emerald-600 dark:text-emerald-300',
            self::ADMIN => 'text-indigo-600 dark:text-indigo-300',
        };
    }
