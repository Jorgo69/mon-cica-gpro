            ...
            <div class="content-wizard bg-card rounded-[2.5rem] p-8 mt-8 lg:p-12 shadow-sm border border-border-light">
                ...
                <form wire:submit.prevent="submitForm">
                    <div class="min-h-[500px]">
                        ...
                        <div x-show="currentStep === 1" x-cloak>@include('livewire.v1.proposal-project.step-1.index')</div>
                        <div x-show="currentStep === 2" x-cloak>@include('livewire.v1.proposal-project.step-2.index')</div>
                        <div x-show="currentStep === 3" x-cloak>@include('livewire.v1.proposal-project.step-3.index')</div>
                        <div x-show="currentStep === 4" x-cloak>@include('livewire.v1.proposal-project.step-4.index')</div>
                        <div x-show="currentStep === 5" x-cloak>@include('livewire.v1.proposal-project.step-5.index')</div>
                        <div x-show="currentStep === 6" x-cloak>@include('livewire.v1.proposal-project.step-final.index')</div>
                    </div>
