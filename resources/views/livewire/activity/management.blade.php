<x-ui.page-layout>
    @if ($activity)
        {{-- Progress Bar --}}
        @include('livewire.activity.partials.progress-bar')
            ...
            <x-ui.section title="Gestion des Sous-Activités" icon="git-branch">
                ...
                @if($showModalForSubActivity)
                    <x-ui.modal :show="true" title="Sous-Activité" closeAction="closeModalForSubActivity">
                        @livewire('sub-activity.sub-activity-form-livewire', [
                ...
                @include('livewire.sub-activity.partials.sub-activity')
            </x-ui.section>
            ...
            <x-ui.section title="Gestion des Ressources" icon="package">
                ...
                @if($showModal)
                    <x-ui.modal :show="true" title="Ressource" closeAction="closeModal">
                        @livewire('resource.resource-form-livewire', [
                            'activityId' => $activity->id,
                ...
                @include('livewire.resource.partials.resource')
            </x-ui.section>
