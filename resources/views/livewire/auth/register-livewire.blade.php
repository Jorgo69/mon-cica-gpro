<div class="space-y-6">
    ...
    <form wire:submit="register" class="space-y-6">
        ...
        <div class="flex gap-3 justify-center">
            ...
            <a href="{{ route('social.redirect', ['provider' => 'google', 'intent' => 'register']) }}" class="flex items-center gap-2 px-5 py-3 rounded-2xl border border-border-light bg-white/50 dark:bg-surface-alt/50 text-xs font-bold text-body hover:border-accent/30 hover:shadow-sm transition-all">
            ...
            <a href="{{ route('social.redirect', ['provider' => 'facebook', 'intent' => 'register']) }}" class="flex items-center gap-2 px-5 py-3 rounded-2xl border border-border-light bg-white/50 dark:bg-surface-alt/50 text-xs font-bold text-body hover:border-accent/30 hover:shadow-sm transition-all">
            ...
            <a href="{{ route('social.redirect', ['provider' => 'microsoft', 'intent' => 'register']) }}" class="flex items-center gap-2 px-5 py-3 rounded-2xl border border-border-light bg-white/50 dark:bg-surface-alt/50 text-xs font-bold text-body hover:border-accent/30 hover:shadow-sm transition-all">
