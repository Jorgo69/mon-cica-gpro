            ...
            <div class="content-wizard bg-card rounded-[2.5rem] p-8 mt-8 lg:p-12 shadow-sm border border-border-light">
                ...
                <form wire:submit.prevent="submitForm">
                    <div class="min-h-[500px]">
                        ...
                        <div x-show="currentStep === 1" x-cloak>@include('livewire.proposal-project.steps.step-1')</div>
                        <div x-show="currentStep === 2" x-cloak>@include('livewire.proposal-project.steps.step-2')</div>
                        <div x-show="currentStep === 3" x-cloak>@include('livewire.proposal-project.steps.step-3')</div>
                        <div x-show="currentStep === 4" x-cloak>@include('livewire.proposal-project.steps.step-4')</div>
                        <div x-show="currentStep === 5" x-cloak>@include('livewire.proposal-project.steps.step-5')</div>
                        <div x-show="currentStep === 6" x-cloak>@include('livewire.proposal-project.steps.step-final')</div>
                    </div>
