<div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
    ...
    @endphp
    <div class="bg-card rounded-xl shadow-lg p-6 border border-border transition-transform hover:scale-105">
        <div class="flex items-center space-x-4">
            <div class="flex-shrink-0 text-accent">
                <x-dynamic-component component="lucide-list-checks" class="w-8 h-8" />
            </div>
            <div>
                <p class="text-sm font-medium text-subtle">Activités</p>
                <p class="text-2xl font-bold text-heading dark:text-white">{{ $totalActivitiesCount }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-card rounded-xl shadow-lg p-6 border border-border transition-transform hover:scale-105">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <p class="text-sm font-medium text-subtle">Terminées</p>
                <p class="text-2xl font-bold text-heading dark:text-white">{{ $completedActivitiesCount }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-card rounded-xl shadow-lg p-6 border border-border transition-transform hover:scale-105">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <p class="text-sm font-medium text-subtle">En cours</p>
                <p class="text-2xl font-bold text-heading dark:text-white">{{ $ongoingActivitiesCount }}</p>
            </div>
        </div>
    </div>
    ...
    <div class="bg-card rounded-xl shadow-lg p-6 border border-border transition-transform hover:scale-105">
        <div class="flex items-center space-x-4">
            ...
            <div>
                <p class="text-sm font-medium text-subtle">En retard</p>
                <p class="text-2xl font-bold text-heading dark:text-white">{{ $lateActivitiesCount }}</p>
            </div>
        </div>
    </div>
</div>