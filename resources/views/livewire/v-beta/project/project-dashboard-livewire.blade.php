    ...
    <div class="max-w-6xl mx-auto">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-8 border border-gray-200 dark:border-gray-700">
            ...
            <div class="w-full bg-gray-200 dark:bg-gray-700 rounded-full h-4 mb-2 overflow-hidden">
                ...
                @endphp
                <div class="h-4 rounded-full transition-all duration-500 ease-in-out bg-yellow-500 " style="width: {{ $progress }}%;"></div>
            </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            ...
            @php
                ...
                $completedActivities = $allActivities->where('progress_percentage', 100)->count();
                $ongoingActivities = $allActivities->where('progress_percentage', '<', 100)->count();
                $lateActivities = $allActivities->where('status', 'En retard')->count();
            @endphp
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 transition-transform hover:scale-105">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800 dark:text-white">{{ $allActivities->count() }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 transition-transform hover:scale-105">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800 dark:text-white">{{ $completedActivities }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 transition-transform hover:scale-105">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800 dark:text-white">{{ $ongoingActivities }}</p>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border border-gray-200 dark:border-gray-700 transition-transform hover:scale-105">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-2xl font-bold text-gray-800 dark:text-white">{{ $lateActivities }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="flex-grow flex flex-col md:flex-row md:space-x-4 space-y-4 md:space-y-0">
                ...
                <div class="w-full md:w-1/3">
                    <select wire:model="perPage" class="w-full py-2 px-4 rounded-lg border border-gray-300 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-gray-100">
                        ...
                        <option value="{{ $project->getAllActivities()->count() }}">Tout afficher</option>
                    </select>
                </div>
            </div>
        </div>
