...
<aside id="sidebar"
    ...
    <nav class="px-3 py-4 pb-20">
        ...
        {{-- ── SUPERVISION ── --}}
        <p class="sidebar-section-title">{{ __('navigation.supervision') }}</p>
        ...
        {{-- ── GESTION ── --}}
        <p class="sidebar-section-title">{{ __('navigation.management') }}</p>
        ...
        <a href="{{ route('system.roles') }}"
           class="nav-item @if(Route::is('system.roles*')) nav-item-active @endif">
            ...
            <span class="nav-label">{{ __('navigation.roles_permissions') }}</span>
        </a>
        ...
        <a href="{{ route('profile.edit') }}"
           class="nav-item @if(Route::is('profile*')) nav-item-active @endif">
            ...
            <span class="nav-label">{{ __('navigation.my_profile') }}</span>
        </a>
